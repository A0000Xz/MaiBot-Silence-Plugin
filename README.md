**这是一个让麦麦更人性化保持沉默的插件，目前支持麦麦的0.9.1main正式版以及0.11.1dev版！**
...
**3.5，如果你的麦麦在0.11.1版本的插件运行过程中被关闭的话，默认解除沉默状态，无后遗症。**
...
**6，永久沉默只可能被指令触发。此外，当麦麦处于沉默状态时，只有三种途径结束她的沉默：到时间了，艾特打断，使用指令强行打断。（重启麦麦也能，但因为第三条的原因，不建议这么做。0.11.1版本请随意，不会有后遗症。）**
