**这是一个让麦麦更人性化保持沉默的插件，目前支持麦麦的0.9.1main正式版以及0.12.2dev版！**
...
**隆重宣布，自0.12.2版本起，沉默插件勉强支持了被禁言时保持沉默的功能！！！**

**此外，还多出了单独对特定用户沉默的配置项，属实验性功能（应该没啥大问题）**
...
**1，本插件的0.9.1版本（对应麦麦版本）具有一定的侵入性，可能会让你对麦麦做的一些代码魔改，或者你使用的一些其他插件出问题。在你的改动不多，或者无重复作用定位的同类型插件出现的情况下，这个插件理应是能正常运行并兼容性很好的。**

**1.5，本插件的0.11.1版本（对应麦麦版本）已使用Event系统等进行了全面重写，侵入性较之前变弱了不少，兼容性也提高了，但仍然可能存在个别的兼容性问题。**

**2，本插件在沉默期间默认会禁止一切的回复行为，包括其他Action类,Command类插件的一切行为。（关于其他插件的命令系统是否受影响是可以被配置的）**

**3，如果你的麦麦（0.9.1）在沉默期间意外被关闭的话，可能会导致一些不可预料的行为发生，请尽量避免在沉默期间关闭你的麦麦。**

**3.5，如果你的麦麦在0.11.1版本及以上的插件运行过程中被关闭的话，默认解除沉默状态，无后遗症。**
...
**6，永久沉默只可能被指令触发。此外，当麦麦处于沉默状态时，只有三种途径结束她的沉默：到时间了，艾特打断，使用指令强行打断。（重启麦麦也能，但因为第三条的原因，不建议这么做。0.11.1版本及以上请随意，不会有后遗症。）**

**6.5，自0.11.1版本起，指令设置的永久沉默只能被指令解除，艾特无法打断，重启麦麦可以。**

**6.7，自0.12.2版本起，指令沉默将能够强制覆盖当前的一切沉默状态。**
